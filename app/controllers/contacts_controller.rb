class ContactsController < ApplicationController
  before_filter :logged_in? 
	...
	def create
		...
		@contact = Contact.new("first_name" => params[:contact][:first_name], "last_name" => params[:contact][:last_name], "phone" => params[:contact][:phone], "email" => params[:contact][:email], "title" => params[:contact][:title])
